...
const rawEnvSchema = z.object({
	...
	JINA_AUTH_ENTRA_AUDIENCE: z.string().optional(),
...
const parseCommaSeparatedValues = (raw: string | undefined): string[] => {
	if (!raw) {
		return [];
	}
...
export const getEnv = (): AppEnv => {
	...
	cachedEnv = {
		...
		entraAudience: parsed.JINA_AUTH_ENTRA_AUDIENCE?.trim() ?? "",
